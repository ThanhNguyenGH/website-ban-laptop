...
<h3><?php echo $m["tenlaptop"]; ?></h3> 
<img src="../../<?php echo isset($m["hinhanh"]) && !empty($m["hinhanh"]) ? $m["hinhanh"] : "images/laptops/default.jpg"; ?>" width="400" class="img-thumbnail"></a>
<p><strong>Hãng: </strong><?php echo $m["tenhang"] ?? ""; ?></p>
<p><strong>CPU: </strong><?php echo $m["cpu"] ?? ""; ?></p>
<p><strong>RAM: </strong><?php echo $m["ram"] ?? ""; ?></p>
<p><strong>Ổ cứng: </strong><?php echo $m["o_cung"] ?? ""; ?></p>
<p><strong>Card màn hình: </strong><?php echo $m["card_man_hinh"] ?? ""; ?></p>
<p><strong>Màn hình: </strong><?php echo $m["man_hinh"] ?? ""; ?></p>
<p><strong>Mô tả chi tiết: </strong><br><?php echo $m["mota_chitiet"] ?? ""; ?></p>
