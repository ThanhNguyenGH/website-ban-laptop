			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item <?php if (strpos($_SERVER['REQUEST_URI'], "qldanhmuc") != false) echo "active"; ?>">
						<a class="sidebar-link" href="../qlhang/index.php">
							<i class="align-middle" data-feather="grid"></i> <span class="align-middle">Quản lý hãng laptop</span>
						</a>
					</li>

					<li class="sidebar-item <?php if (strpos($_SERVER['REQUEST_URI'], "qllaptop") != false) echo "active"; ?>">
						<a class="sidebar-link" href="../qllaptop/index.php">
							<i class="align-middle" data-feather="package"></i> <span class="align-middle">Quản lý Laptop</span>
						</a>
					</li>
