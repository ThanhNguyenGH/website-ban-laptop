  ...
  <div class="row"> 
	...
	<form method="post" action="index.php">
		...
		<div class="my-3">
			...
			<textarea class="form-control" name="txtdiachi" required><?php echo $_SESSION["khachhang"]["diachi"] ?? ""; ?></textarea>
		</div>
		<div class="my-3">
			<label>Phương thức thanh toán</label>
			<select class="form-select" name="optthanhtoan">
	...
	<h4 class="text-info">Thông tin đơn hàng</h4>
		...
		<tr>
		<td><img width="50" src="../<?php echo $mh["hinhanh_chinh"]; ?>"><?php echo $mh["tenlaptop"]; ?></td>
